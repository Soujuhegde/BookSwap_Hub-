          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6">
            <div className="flex border-b border-border">
              <button
                ...
                className={`relative px-6 py-3 font-medium transition-colors duration-150 ease-out ${activeTab === 'received' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`
                }>
              ...
              <button
                ...
                className={`relative px-6 py-3 font-medium transition-colors duration-150 ease-out ${activeTab === 'sent' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`
                }>

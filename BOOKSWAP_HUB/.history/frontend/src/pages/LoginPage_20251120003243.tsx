...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    console.log('LoginPage useEffect - user:', user, 'token:', token, 'storedUser:', storedUser);
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center mb-4">
            <span className="text-3xl font-bold text-primary-600 font-pacifico">BookSwap Hub</span>
          </Link>

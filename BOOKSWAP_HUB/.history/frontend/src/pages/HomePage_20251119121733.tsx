        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-primary-600 font-pacifico">
                BookSwap Hub
              </h1>
            </div>
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/my-books" className="text-gray-700 hover:text-primary-600">
                List a Book
              </Link>
              <Link to="/how-it-works" className="text-gray-700 hover:text-primary-600">
                How It Works
              </Link>
